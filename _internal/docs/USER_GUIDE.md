...
**Document Length:** 10+ pages of feature walkthrough, data sources, and interpretation guidance  
**Architecture:** Multi-page hub (Market, Stablecoins, Competition, Opportunity, Playbook, Methodology) with 21st.dev premium UI integration (Animated Backgrounds, Cinematic Footer, Hybrid Spotlight Cards).
...
| 3 | Quidax has a regulatory advantage | Competitive Matrix (Section 6) | Column "Licensed?"; Quidax and Busha are the only two SEC ARIP-licensed players (Nigeria) |
...
|--------|-------|
| Player | Quidax |
| Licensed? | Yes (SEC ARIP provisional, August 2024 cohort) |
| NGN Pairs | 11 |
| B2B API? | Yes (live) |
| Stablecoin Focus | ~95% |
...
|--------|-------|
| Player | Luno |
| Licensed? | Active in Nigeria; no ARIP provisional licence equivalent |
...
**How to Read This:**
- **For a regulator:** Scan "Licensed?" column; Quidax and Busha are the only ARIP-licensed players
...
**Visual Format:** Four corridor cards (NG→CN, NG→AE, NG↔KE, Diaspora→NG)
...
**Flow Volume:**
```
$20–22 B / year (official World Bank), ~$23B including informal channels
```
