...
- **cNGN** (Nigerian Naira stablecoin, issued by the African Stablecoin Consortium under SEC ARIP oversight): Should equal ₦1 Nigerian Naira
...
- **Medium**: Nigeria→China corridor is $13B/year = MEDIUM (NBS trade data, updated annually)
- **Low**: Nigeria↔Kenya corridor = LOW ($100M, aspirational AfCFTA estimate)
