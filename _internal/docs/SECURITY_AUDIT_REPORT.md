...
| **Quidax Retail Volume** | ~$8–12 M | 24h volume observed on selected pairs during audit via public API | Live | Snapshot Input | Sourced from /api/v1/markets/tickers during audit |
...
| **Yellow Card: B2B Pivot Date** | January 1, 2026 | Crunchbase, TechCrunch coverage, Yellow Card blog | 2026-05-12 | Medium | Corrected to official January 1, 2026 discontinuation date |
...
| Yellow Card pivot year | Corrected | Updated to official January 1, 2026 | 3dffae2 |
