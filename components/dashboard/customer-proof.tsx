    ...
    <section id="customers" className="mx-auto w-full max-w-7xl px-4 py-12 md:px-6" aria-labelledby="customers-title">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {QUIDAX_B2B_CUSTOMERS.map((c, idx) => {
          const CardTag = "url" in c && c.url ? "a" : "div"
          const props = "url" in c && c.url ? { href: c.url, target: "_blank", rel: "noopener noreferrer" } : {}
          ...
          return (
            ...
            >
              ...
              <h3 className={["mt-4 text-xl font-semibold tracking-tight", "url" in c && c.url ? "group-hover:text-primary group-hover:underline" : ""].join(" ")}>{c.name}</h3>
