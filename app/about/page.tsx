...
/**
 * Separates candidate framing from the analysis.
        ...
        <div className="mt-10 flex flex-col gap-6">
          <section>
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              I wanted an honest test of whether I can do the kind of analyst, data, and product-thinking work an exchange-as-a-service business actually needs, and a forcing function to learn the regulatory and competitive ground in detail. The dashboard is the result. The methodology page is the homework I had to do to ship it without overclaiming.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              This dashboard uses only publicly available market data and publicly verifiable competitor information. It is independent and not affiliated with Quidax Technologies Limited or any other exchange. The information here is for analysis. It is not investment advice.
            </p>
          </section>
        </div>
      </section>
